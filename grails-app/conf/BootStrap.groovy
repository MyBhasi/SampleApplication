...
//        Role adminRole = Role.findByAuthority('ROLE_ADMIN') ?: new Role(authority: 'ROLE_ADMIN').save(failOnError: true, flush: true)
        MyUser adminUser1=MyUser.findByUsername("bhaskar@gmail.com") ?:
                new MyUser(username: "bhaskar@gmail.com", password: "bhaskardefault",firstName: "bhaskar",lastName: "singh" ,phoneNo:"9899856955"   ,admin:true , enabled: true).save(failOnError: true, flush: true)
        ...
        MyUser ownerUser1=MyUser.findByUsername("deepak@gmail.com") ?:
                new MyUser(username: "deepak@gmail.com", password: "bhaskardefault",firstName: "deepak",lastName: "kumar" ,admin:false,phoneNo:'9868846163' , enabled: true).save(failOnError: true, flush: true)
        ...
        MyUser agentUser1=MyUser.findByUsername("ashish@gmail.com") ?:
                new MyUser(username: "ashish@gmail.com", password: "bhaskardefault", firstName: "ashish",lastName: "gautam",admin: false, enabled: true).save(failOnError: true, flush: true)
        ...
        MyUser customerUser1=MyUser.findByUsername("adarsh@gmail.com") ?:
                new MyUser(username: "adarsh@gmail.com", password: "bhaskardefault",firstName: "adarsh",lastName: "tiwari",admin:false, enabled: true).save(failOnError: true, flush: true)
