...
<g:form method ="post" class="bs-component"  enctype="multipart/form-data"  controller="property" action="saveOffice" >
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="focusedInput" type="text" name="address" value="${property?.address}" placeholder="Address">
        <g:hasErrors field="address"  bean="${}">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="disabledInput" type="number"  name="pincode" value="${property?.pincode}" placeholder="pincode" >
    ...
    <div class="form-group ">
        ...
        <input type="text" class="form-control" id="inputWarning" name="city" value="${property?.city}"   placeholder="city">
    ...
    <div class="form-group ">
        ...
        <input type="number" class="form-control" id="exampleInputAmount" name="price"
               placeholder="Amount"  value="${property?.price}">
    ...
    <div class="btn-group" data-toggle="buttons">
        <label>Cafeteria</label><g:select name="cafeteriaAvailibility"
                                          from="${['Yes','No']}"
                                          noSelection="['': 'choose']" value="${property?.cafeteriaAvailibility}"/>
    ...
    <div class="btn-group" data-toggle="buttons">
        <label>ParkingFacility</label><br><g:select name="parkingFacility"
                                                    from="${['yes','No']}"
                                                    noSelection="['': 'choose']" value="${property?.parkingFacility}"/>
    ...
    <div class="form-group ">
        ...
        <input type="number" class="form-control" id="inputWarning" name="size" value="${property?.size}"   placeholder="size in Sq.ft">
    ...
    <div class="form-group ">
        ...
        <input type="number" class="form-control" value="${property?.floorNo}" name="floorNo" placeholder="floorNo">
